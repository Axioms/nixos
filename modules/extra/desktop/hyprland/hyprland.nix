    ...
    home-manager.users.axiom = {
      ...
      wayland.windowManager.hyprland = {
        ...
        extraConfig = ''
          ...
          bind = $mainMod+Alt, V, exec, python ~/Documents/git/streamdeck-pipewire/SwitchSink.py AppToSink
