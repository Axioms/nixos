...
''
  <domain type="kvm">
    ...
    <uuid>7d259939-e439-4d58-a96d-6829bd41d231</uuid>
    <metadata>
    ...
    <os firmware="efi">
      ...
      <nvram template="${config.virtualisation.libvirtd.qemu.package}/share/qemu/edk2-i386-vars.fd" templateFormat="raw" format="raw">/var/lib/libvirt/qemu/nvram/almalinux9_VARS.fd</nvram>
      <bootmenu enable="yes"/>
    </os>
    <features>
      <acpi/>
    ...
    <devices>
      ...
      <disk type="file" device="cdrom">
        ...
        <source file="/mnt/data/ISOs/OS/AlmaLinux-9.4-x86_64-minimal.iso"/>
